    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-8" id="mailbox">
                <span id="title"><b>Sent Mails</b></span>
                <form name="delete" action="#" method="post">
                    <table class="table table-striped " id="tab">
                        ...
                        ?>
                                <?php
                             $id=$_SESSION['userid'];
                              $sql=mysql_query("select * from mail where sender='$id' and SC=0 order by msg_id DESC LIMIT $startrow,10");
